...
\item{$\bullet$}{[Spegling av laddning i plan] L{\"o}sningen $\phi({\bf x})$ till
  Poissons ekvation f{\"o}r en punktladdning $q$ placerad ett avst{\aa}nd
  $z=h$ ovanf{\"o}r ett perfekt ledande plan $z=0$ ges som frirymdl{\"o}sningen
  med en virtuell spegelladdning $-q$ placerad p{\aa} samma avst{\aa}nd bakom
  planet, vid $z=-h$.}

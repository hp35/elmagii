...
att\numberedfootnote{V{\"a}n av ordning kan h{\"a}r fr{\aa}ga sig hur vi
  ...
  m{\aa}ste $\nabla\cdot{\bf B}$ evaluera till samma konstant, specifikt
  {\"a}ven d{\aa} vi passerar eller startar fr{\aa}n n{\aa}gon tid d{\aa}
  vi r{\aa}kar ha en {\it statisk} situation d{\aa} uppenbarligen
...
\subsection{Den generella formen av v{\aa}gekvationen f{\"o}r potentialer}

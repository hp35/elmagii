...
\plan{I och med denna f{\"o}rel{\"a}sning l{\"a}mnar vi vakuumbeskrivningen av
  f{\"a}lt och g{\aa} in p{\aa} v{\"a}xelverkan mellan elektriska eller
  ...
  fl{\"o}dest{\"a}theten ${\bf D}$ som $\nabla\cdot{\rho}_{\bf f}$, d{\"a}r
  ${\rho}_{\bf f}$ {\"a}r den fria laddningst{\"a}theten. Randvillkor och
  {\"o}verg{\aa}ngar mellan olika dielektrika h{\"a}rleds f{\"o}r den
  elektriska f{\"a}ltstyrkan ${\bf E}$ och den elektriska

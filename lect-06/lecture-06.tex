...
kraften ${\bf F}_{\rm e}$. Vi kan notera att vi {\it generellt har att en
sf{\"a}risk laddningsf{\"o}rdelning agerar s{\aa} som om vi hade att g{\"o}ra
med en punktladdning placerad i den sf{\"a}riska f{\"o}rdelningens centrum, med
det elektriska f{\"a}ltet motsvarande den laddning som innesluts med den radie
fr{\aa}n centrum som n{\aa}r observat{\"o}ren}.
\epsfig{figs/gravity.1}\noindent
F{\"o}r ett sf{\"a}riskt-symmetriskt ``moln'' av laddning, centrerat i origo,
har vi helt klart att vi vid varje position runtomkring inuti s{\aa}v{\"a}l
som utanf{\"o}r molnet har att det elektriska f{\"a}ltet endast har en radiell
komponent, med tecken beroende p{\aa} om den totala inneslutna laddningen
{\"a}r positiv eller negativ. Formulerat med Gauss lag har vi d{\"a}rmed att
$$
  \oiint_{\Omega:|{\bf x}|=r}{\bf E}\cdot d{\bf A}
    =4\pi r^2 E_r(r)
...
$$
  E_r(r)={{1}\over{4\pi\varepsilon_0 r^2}}
           \underbrace{\int^r_0\rho(r') 4\pi r'^2\,dr'}_{\equiv q_{\rm enc}}
        ={{q_{\rm enc}}\over{4\pi\varepsilon_0 r^2}},
$$
d{\"a}r $q_{\rm enc}$ {\"a}r den laddning som innesluts av sf{\"a}ren med samma
radie $r$ som avst{\aa}ndet till en observat{\"o}r. {\it Notera att denna form
{\"a}r identisk med den som skuller erh{\aa}llas f{\"o}r situationen d{\aa}
all innesluten laddning $q_{\rm enc}$ ist{\"a}llet skulle placerats som en
punktladdning i origo.}
...
tyngdkraft, motsvarande attraktionskraften fr{\aa}n den massa $m_{\rm enc}$ som
omsluts av den radie $r$ vid vilken vi r{\aa}kar befinna oss

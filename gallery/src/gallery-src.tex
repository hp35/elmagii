...
\def\heaviside{%
  \portrait{images/oliver_heaviside_scaled_bw.eps}%
    ...
    {1850--1925}%
    {\ifswedish
      {Brittisk matematiker och elektroingenj{\"o}r som utvecklade tekniker f{\"o}r att l{\"o}sa differentialekvationer, ekvivalent till Laplace-transformen, utvecklade den moderna vektoranalysen och formulerade Maxwells ekvationer p{\aa} den kocisa och kompakta form som idag anv{\"a}nds. Uppfann koaxialkabeln och {\"a}r namnet bakom Heaviside-funktionen $H(x)$.}
    \else

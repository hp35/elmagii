...
\vskip 0pc\goodbreak\noindent
\def\gallerytitletext{}
\ifnum\lang=\swedish
  \def\gallerytitletext{Portr{\"a}ttgalleri inom klassisk elektromagnetism}
\else
  \def\gallerytitletext{Portrait gallery in classical electromagnetism}
\fi

\noindent{\twelvecmbx\gallerytitletext}

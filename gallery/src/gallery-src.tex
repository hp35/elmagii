...
\def\thomson{%
  \portrait{images/joseph_john_thomson_scaled_bw.eps}%
    ...
    {1856--1940}%
    {\ifswedish
      {Brittisk fysiker, Nobelpris i fysik 1906. Genom experiment med
      katodstr{\aa}ler{\"o}r p{\aa}visade han 1897 existensen av elektroner.
      Genom m{\"a}t\-ningar av hur katodstr{\aa}lar kunde f{\aa}s att
...
\def\debroglie{%
  \portrait{images/louis_de_broglie_scaled_bw.eps}%
    ...
    {1892--1987}%
    {\ifswedish
      {7th Duc de Broglie. Fransk teoretisk fysiker och aristokrat. I sin doktorsavhandling 1924 postulerade han att elektroner s{\aa}v{\"a}l som all annan materia har v{\aa}gegenskaper med v{\aa}g\-l{\"a}ngd $\lambda=h/p$, den s{\aa} kallade v{\aa}g--partikel\-dualiteten. De Broglie erh{\"o}ll 1929 Nobelpriset i fysik efter att hans hypotes 1927 bekr{\"a}ftats experimentellt av C.~Davisson och L.~Germer.}
    \else
{(French: [də bʁɔj] ⓘ;[2] 15 August 1892 – 19 March 1987)[3] was a French theoretical physicist and aristocrat known for his contributions to quantum theory. In his 1924 Ph.D. thesis, he postulated the wave nature of electrons and suggested that all matter has wave properties. This concept is known as the de Broglie hypothesis, an example of wave–particle duality, and forms a central part of the theory of quantum mechanics. In 1929, de Broglie won the Nobel Prize in Physics, after the wave-like behaviour of matter was experimentally confirmed in 1927.}
    \fi}%
    \sidx{Thomson, Joseph John (1856--1940)}
}
...
\portraitpage{\dalembert}{\ampere}{\biot}{\debroglie}
\portraitysize=300pt
\portraitpage{\coulomb}{\faraday}{\dufay}{\feynman}
\portraitpage{\franklin}{\gauss}{\gilbert}{\heaviside}
\portraitpage{\kelvin}{\laplace}{\lenz}{\lorentz}
\portraitpage{\lorenz}{\maxwell}{\neumann}{\oersted}
\portraitpage{\poisson}{\savart}{\stokes}{\tesla}
\portraitpage{\thomson}{\weber}{\wilson}{}{}

...
\def\franklin{%
  \portrait{images/benjamin_franklin_scaled_bw.eps}%
    ...
    {American polymath. One of the Founding Fathers of the United States
     and signer of the Declaration of Independence. Conducted experiments proposing that du Fay's ``vitreous'' and ``resinous'' electricity were not different
types of ``electrical fluid'', but of same type, labeled as positive and negative. First to discover the principle of conservation of charge.
...
\portraitpage{\laplace}{\lorentz}{\lorenz}{\maxwell}
\portraitpage{\neumann}{\oersted}{\poisson}{\savart}
\portraitpair{\stokes}{\wilson}
\bye

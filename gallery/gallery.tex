...
%  \hbox{%
    \boxit{%
      \vbox{%
        \boxit{%
%          \hbox{\epsfxsize=\portraitsize\epsfbox{#1}}
          \hbox to \portraitsize{\epsfysize=200pt\hfil\epsfbox{#1}\hfil}
        }%
      \hbox{\vbox{\hsize=\portraitsize\parindent=0pt{#2}}}
      }%
    }%
%  }%
}
...
\hbox{
  \portrait{images/jean_le_rond_dalembert_scaled_bw.eps}{Jean Le Rond
    d'Alembert (1717--1783). French mathematician, mechanician, physicist,
    philosopher, and music theorist. In this course we are using d'Alembert's
    formulation of wave propagation in the form $f(z-ct)+g(z+ct)$.
    \sidx{d'Alembert, Jean le Rond (1717--1783)}}
  \hskip30pt
  \portrait{images/andre_ampere_scaled_bw.eps}{Andr\'e-Marie Amp\`ere
    (1775--1836). French physicist and mathematician. One of the principal
...
\portrait{images/michael_faraday_scaled_bw.eps}{Michael Faraday (1791--1867).
...
\portrait{images/lord_kelvin_scaled_bw.eps}{William Thomson, 1st Baron
  Kelvin (1824--1907). British mathematician, mathematical physicist
  and engineer. In this course we focus on the Kelvin--Stokes theorem,
...
\portrait{images/hans_christian_oersted_scaled_bw.eps}{Hans Christian
  {\OE}rsted (1777--1851). Danish chemist and physicist who discovered
  that electric currents create magnetic fields.
  \sidx{{\OE}rsted, Hans Christian (1777--1851)}}

\portrait{images/hendrik_lorentz_scaled_bw.eps}{Hendrik Antoon Lorentz
  (1853--1928). Dutch theoretical physicist who shared the 1902 Nobel
...
\portrait{images/ludvig_valentin_lorenz_scaled_bw.eps}{Ludvig Lorenz
  (1829--1891). Danish physicist and mathematician. In 1867, Lorenz gave
...
\portrait{images/charles_de_coulomb_scaled_bw.eps}{Charles-Augustin de
  Coulomb (1736--1806). French officer, engineer, and physicist. Discoverer
  of the law describing the electrostatic force of attraction and repulsion,

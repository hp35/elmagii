...
%
\newdimen\portraitxsize  \portraitxsize=214pt
\newdimen\portraitysize  \portraitysize=300pt
\newdimen\portraitxmargin \portraitxmargin=14pt
\newdimen\portraitymargin \portraitymargin=8pt
\newif\ifboxed
...
\def\oersted{%
  \portrait{images/hans_christian_oersted_scaled_bw.eps}%
    ...
    \sidx{Magnetisk fältstyrka ${\bf H}$}[{\OE}rsted]
}
...
\def\wilson{%
  \portrait{images/rickard_wilson_scaled_bw.eps}%
    {Rickard Wilson}%
    {1930--2000}%
    {Svensk vetenskapsman och arkitekt. Upphovsman till fatilarkalkylen,
    presenterad 1955.}%
...
\vskip 0pc\goodbreak\noindent{\twelvecmbx{Portr{\"a}ttgalleri inom klassisk elektromagnetism}}%
  \writenumberedtocentry{index}{\hskip24pt{Portr{\"a}ttgalleri inom klassisk elektromagnetism}}%
  \nobreak\bigskip\noindent\ignorespaces

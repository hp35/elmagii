...
\def\faraday{%
  \portrait{images/michael_faraday_scaled_bw.eps}%
    ...
    {\ifswedish
      ...
      $$
      vilken kan h{\"a}rledas fr{\aa}n Lorentz kraftlag.}
    \else
      ...
      $$
        ...
        {\cal E}= -{{d\Phi_{\rm M}}\over{dt}}
          ...
          \nabla\times{\bf E}=-{{\partial{\bf B}}\over{\partial t}},
      $$
      which can be derived from the Lorentz force.}
    \fi}%
...
\def\feynman{%
  \portrait{images/richard_feynman_drums_scaled_bw.eps}%
    ...
    {1918--1988}%
    {\ifswedish
      {Amerikansk teoretisk fysiker vid California Institute of Technology (Caltech). Feynman formulerade meto\-di\-ken f{\"o}r v{\"a}gintegraler ({\it path integrals}) inom kvantmekanik samt grundl{\"a}gg\-an\-de teori f{\"o}r kvantelektrodynamik (QED). F{\"o}r sina bidrag till QED erh{\"o}ll han 1965 Nobelpriset i fysik tillsammans med Julian Schwinger and Shin'ichir{\=o} Tomonaga.}
    \else
...
\def\franklin{%
  \portrait{images/benjamin_franklin_scaled_bw.eps}%
    ...
    % f{\"o}r att bevisa sin teori kring “en-v{\"a}tskehypotesen”, d{\"a}r han
    % argumenterade f{\"o}r att du Fays “vitreous och resinuous” dubbel-v{\"a}tsketori
    % var felaktig och att det bara fanns en typ av “elektrisk v{\"a}tska”,
    % och att alla elektrostatiska effekter kunde sp{\aa}ras till ett {\"o}verfl{\"o}d
    % respektive underskott av denna “v{\"a}tska”. Franklin betecknade dessa
    % som positivt ({\"o}verfl{\"o}d) respektive negativt (underskott) av elektrisk
...
\portraitpage{\savart}{\stokes}{\tesla}{\wilson}

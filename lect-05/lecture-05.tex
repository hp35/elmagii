...
\plan{{\"A}mnet f{\"o}r f{\"o}rel{\"a}sningen beskrivs kort och koncist
  ...
  definitionerna av magnetiskt fl{\"o}de och det historiskt betingade
  begreppet elektromotorisk ``kraft''.
  Vi h{\"a}rleder Faradays induktionslag i tv{\aa} separata och inb{\"o}rdes
  sammanh{\aa}llna fall. Det f{\"o}rsta fallet introduceras f{\"o}r sin
  enkelhet och intuitivt greppbara geometri, d{\"a}r vi studerar en
  rektangul{\"a}r str{\"o}mslinga som f{\"o}rs genom ett inhomogent magnetiskt
  f{\"a}lt och kommer fram till formen p{\aa} Faradays induktionslag.
  Det andra fallet {\"a}r en formell h{\"a}rledning av Faradays induktionslag
  f{\"o}r en godtycklig r{\"o}rligt geometri i form av en slinga med godtycklig
  hastighet l{\"a}ngs med sin trajektoria, samt med ett godtyckligt varierande
  magnetf{\"a}lt. Vi noterar att Faradays induktionslag h{\"a}rleds enbart
  utifr{\aa}n Lorentz kraftlag och ej involverande vare sig Coulombs eller
  Biot--Savarts lag eller n{\aa}ot av deras derivat i det elektromagnetiska
  ``sl{\"a}kttr{\"a}det''; i och med detta har vi i Faradays induktionslag
  avsaknad av s{\aa}v{\"a}l den elektriska permittiviteten $\varepsilon_0$
  som den magnetiska permeabiliteten $\mu_0$.
  ...
  till att den uppkom, och vi g{\aa}r utifr{\aa}n denna princip igenom en
  samling med tankeexperiment med b{\"a}ring p{\aa} tolkning av
  elektromagnetisk induktion.
  Med utg{\aa}ngspunkt i Faradays induktionslag h{\"a}rleder vi Faradays lag,
  eller ``Maxwell--Faradays lag'', p{\aa} differential- och integralform.
  ...
  vi igenom tolkningen av Neumanns formel i form av reciprocitet mellan
  tv{\aa} slingor, d{\"a}r vi har det sm{\aa}tt f{\"o}rbluffande resultatet
  att det magnetiska fl{\"o}de som uppf{\aa}ngas av en slinga fr{\aa}n en
  str{\"o}m i den andra slingan exakt motsvaras av det magnetiska fl{\"o}de
  som den andra slingan skulle uppf{\aa}nga om ist{\"a}llet den f{\"o}rsta
  slingan drevs med exakt samma str{\"o}m.}
...
$$
Vi brukar i vardagligt tal kalla denna ekvation {\it Faradays
induktionslag}\numberedfootnote{Denna beteckning {\"a}r i sig lite olycklig,
  d{\aa} vi l{\"a}tt kan associera denna med Faradays lag p{\aa}
  differentialform som vi inom kort kommer att stifta bekantskap med,
$$
  \nabla\times{\bf E}=-{{\partial{\bf B}}\over{\partial t}}.
$$
Dock kommer vi inom kort att visa hur denna kan h{\"a}rmedas ur just Faradays
induktionslag p{\aa} formen som involverar magnetiska fl{\"o}det $\Phi_{\rm M}$.
Vissa textb{\"o}cker inom elektromagnetism tar Faradays lag p{\aa} denna
differentialform som ett {\it axiom} (postulat) utan att visa p{\aa} hur formen
uppkommer, och g{\aa}r helt enkelt till att visa hur induktionslagen erh{\aa}lls
fr{\aa}n denna form; detta {\"a}r dock fusk och ett cirkelresonemang som vi
skall h{\aa}lla oss borta fr{\aa}n i m{\"o}jligaste m{\aa}n.}, eller kort och
gott bara {\it induktionslagen}.

Vi skall h{\"a}r notera att Faradays induktionslag, fr{\aa}n vilken vi sedan
h{\"a}rleder Faradays lag (eller ``Maxwell--Faradays lag'', som
engelsk-spr{\aa}kig litteratur ofta betecknar den) inte {\"a}r m{\"o}jlig att
h{\"a}rleda enbart fr{\aa}n elektrostatiska eller magnetostatiska teorem som
Coulombs eller Biot--Savarts lag. Induktion {\"a}r ett strikt {\it dynamiskt}
fenomen d{\"a}r vi v{\"a}ljer att antingen
\medskip
...
g{\aa}ng f{\"o}r alla visa p{\aa} ursprunget f{\"o}r denna oerh{\"o}rt
fundamentala lag inom elektrodynamiken.\numberedfootnote{Det {\"a}r
  oerh{\"o}rt vanligt att se ``h{\"a}rledningar'' av Faradays induktionslag
  (``magnetiska fl{\"o}des\-lagen'') ${\cal E}=-d\Phi_{\rm M}/dt$ utg{\aa}ende
  ...
  (Faradays lag kommer att h{\"a}rledas fr{\aa}n induktionslagen i denna
  f{\"o}rel{\"a}sning.) Denna approach ger endast ett cirkelresonemang,
  d{\"a}r den ena vyn {\"o}msesidigt bevisar den andra, och om man fr{\aa}gar
  exempelvis ChatGPT, Grok eller n{\aa}gon annan LLM ({\it large language
  model}) s{\aa} finner man sorgligt nog direkt att svaret man f{\aa}r s{\aa}
  gott som uteslutande bygger p{\aa} just Faradays lag som ett axiom.}
...
${\bf B}$ {\"o}ver den yta $S$ som innesluts av den slutna trajektorian
$\Gamma$, som
$$
...
med en slags densitet av fl{\"o}de per ytenhet, eller kort och gott som just
en {\it magnetisk fl{\"o}dest{\"a}thet}. Vi kan p{\aa} s{\"a}tt och vis
...
slinga $\Gamma$ och integrerar den kraft som verkar p{\aa} punktladdningen
och dividerar denna med laddningen i sig, s{\aa} f{\aa}r vi den resulterande
potentialskillnad som agerar f{\"o}r att skicka laddningen som en str{\"o}m
genom slingan. Den potentialskillnad som ackumulerats runt slingan {\"a}r d{\aa}
$$
...
Innan vi ger oss in p{\aa} en generell h{\"a}rledning, som riskerar att f{\aa}
oss att fastna i vektoralgebra och tappa fokus p{\aa} sj{\"a}lva k{\"a}rnan i
Faradays induktionslag, l{\aa}t oss betrakta ett f{\"o}renklat fall med en
rektangul{\"a}r slinga $\Gamma$ som med konstant hastighet ${\bf v}_0$ dras
ut ur ett rektangul{\"a}rt omr{\aa}de med ett homogent magnetf{\"a}lt
${\bf B}_0$, ortogonalt mot slingans plan och ortogonalt mot den konstanta
hastigheten ${\bf v}_0$.
...
magnetf{\"a}ltet och d{\"a}rmed {\"a}ven det ger noll i bidrag,
s{\aa} {\"a}r det endast segment 1 som ger ett nettobidrag till v{\aa}r
    ...
    {\cal E}&=\oint_{\Gamma}\bigg({{{\bf F}}\over{q}}\bigg)\cdot d{\bf l}
      ...
      &=\oint_{\hbox{\encircle{1}}}({\bf v}\times{\bf B}_0)\cdot d{\bf l}
          ...
          +\oint_{\hbox{\encircle{3}}}
              ({\bf v}\times\underbrace{{\bf B}_0}_{=0})\cdot d{\bf l}
...
$$
Samtidigt har vi att det magnetiska fl{\"o}de $\Phi_{\rm M}$ som t{\"a}cks av
slingan ges av ytintegralen\numberedfootnote{Vi skall h{\"a}r komma ih{\aa}g
  att integrationsriktningen som vi valt f{\"o}r den slutna linjeintegralen
  {\"o}ver slignan $\Gamma$ dessutom best{\"a}mmer vilken riktning v{\aa}ra
...
{\"o}ver den yta $S$ som innesluts av slingan $\Gamma$. Det magnetiska
fl{\"o}det har en f{\"o}r{\"a}ndring i tiden som ges av
$$
  \eqalign{
    {{d\Phi_{\rm M}}\over{dt}}&={{d}\over{dt}}\iint_S{\bf B}_0\cdot d{\bf S}
       ={{d}\over{dt}}\iint_S (B_0{\bf e}_y)\cdot
         (\underbrace{-{\bf e}_ydA}_{=d{\bf S}})
       =-B_0{{d}\over{dt}}\big((h-v_0 t)L\big)\cr
      &=\underbrace{v_0 B_0 L}_{=-{\cal E}}\cr
  }
$$
Ur detta f{\"o}renklade resonemang kan vi d{\"a}rmed dra slutsatsen att den i
...
Notera att Faradays induktionslag enligt ovan h{\"a}rleddes enbart under
antagandet om Lorentz-kraften p{\aa} laddade partiklar i r{\"o}relse.
Vi har i h{\"a}rledningen inte anv{\"a}nt vare sig Coulombs lag eller n{\aa}gon
av de fr{\aa}n den h{\"a}rledda satserna, och d{\"a}rmed kan vi konstatera att
den elektriska permittiviteten $\varepsilon_0$ lyser med sin fr{\aa}nvaro.
...
{\"a}r just Lorentz kraftlag, vilket ger oss vid hand att vi i och med denna
{\"a}r n{\aa}got nytt p{\aa} sp{\aa}ret.
...
innesluter n{\aa}got magnetiskt (och f{\"o}r den delen elektriskt) f{\"a}lt.
...
av slingan $\Gamma$, och {\"a}ven detta m{\aa}tt kan sj{\"a}lvfallet integreras
{\"o}ver en yta som inte n{\"o}dv{\"a}ndigtvis m{\aa}ste ringas in av en fysisk
str{\"o}mslinga.

Med andra ord visar detta p{\aa} att Faradays induktionslag handlar om
n{\aa}got djupare {\"a}n bara generatorer, med b{\"a}ring p{\aa} en
...
elektrodynamik och i f{\"o}rl{\"a}ngningen elektromagnetisk v{\aa}gutbredning}.
...
h{\"o}gerledet. Detta negativa tecken {\"a}r en signatur av att den genererade
elektromotoriska ``kraften'', eller om vi s{\aa} vill den i slingan genererade
str{\"o}mmen i det fall att vi har en fysisk ledare som slinga, alltid kommer
att genereras s{\aa} att den har en riktning som motverkar k{\"a}llan till
induktionen. Denna princip, som brukar betecknas med {\it Lenz lag}, bist{\aa}r
med ett synnerligen kraftfullt verktyg n{\"a}r det kommer till punkten att vi
skall tolka ett resultat eller g{\"o}ra en {\it sanity check} p{\aa} att ett
resultat verkar rimligt.
...
Vi har s{\aa} l{\aa}ngt utifr{\aa}n en illustrativ men mycket f{\"o}renklad
geometri visat p{\aa} en {\it sannolik} form av Faradays induktionslag, men
...
en generell trajektoria $\Gamma(t)$, l{\"a}ngs med vilken varje element
till{\aa}ts ha en godtycklig hastighet ${\bf v}({\bf x},t)$ som har ett
godtyckligt beroende i tid och rum. Denna generalitet g{\"o}r sj{\"a}lvfallet
att {\"a}ven den omslutna arean och riktningen av ytnormalen till{\aa}ts att
variera fritt. Vi till{\aa}ter vidare att det av trajektorian inneslutna
magnetf{\"a}ltet ${\bf B}({\bf x},t)$ till{\aa}ts att variera fritt i tid
...
L{\aa}t oss nu se vad f{\"o}r{\"a}ndringen i magnetiskt fl{\"o}de
$d\Phi_{\rm M}$ kan t{\"a}nkas vara f{\"o}r en s{\aa} generell konstruktion.
D{\aa} trajektorian $\Gamma(t)$ r{\"o}r sig, fr{\aa}n tiden $t$ till tiden
$t+dt$ strax d{\"a}refter, kommer f{\"o}r{\"a}ndringen i magnetiskt fl{\"o}de
att ges som alla delbidrag i den ``remsa'' som i rummet beskrivs av zonen
mellan $\Gamma(t)$ och $\Gamma(t+dt)$,
$$
...
mellan den str{\"a}cka som elementet vid ${\bf x}$ av trajektorian
  ...
  \eqalign{
    d\Phi_{\rm M}
      ...
      &=\oint_{\Gamma(t)}{\bf B}({\bf x},t)
             \cdot({\bf v}({\bf x},t)\times d{\bf l})\,dt\cr
      &=dt\oint_{\Gamma(t)}{\bf B}({\bf x},t)
             \cdot({\bf v}({\bf x},t)\times d{\bf l}),\cr
  }
$$
med andra ord kan vi formulera f{\"o}r{\"a}ndringen av det magnetiska
fl{\"o}det genom trajektorian $\Gamma(t)$ som den f{\"o}rv{\"a}ntade
tidsderivatan
$$
  \eqalign{
    {{d\Phi_{\rm M}}\over{dt}}
...
Om vi t{\"a}nker oss att en laddning l{\"a}ngs med trajektorian $\Gamma(t)$
har hastigheten ${\bf u}({\bf x},t)$, s{\aa} {\"a}r sj{\"a}lvfallet denna
...
$$
\vfill\eject
Notera h{\"a}r att eftersom ${\bf u}({\bf x},t)$ {\"a}r parallell med
linjeelementet $d{\bf l}$, s{\aa} kommer samma linjeelements kryssprodukt
med ${\bf v}({\bf x},t)$ att ge en produkt som {\"a}r ortogonal mot just
...
${\bf w}({\bf x},t)$ i och med att produkten med det magnetiska f{\"a}ltet
...
ett strikt s{\"a}tt h{\"a}rlett Faradays induktionslag som
$$
  {\cal E}=-{{d\Phi_{\rm M}}\over{dt}}.
$$
Vi erinrar oss att denna h{\"a}rletts endast utifr{\aa}n Lorentz-kraften
agerande p{\aa} en hypotetisk laddning, och att denna d{\"a}rmed dels {\"a}r
i avsaknad av s{\aa}v{\"a}l den elektriska permittiviteten $\varepsilon_0$
som den magnetiska permeabiliteten $\mu_0$.

Vi tar ocks{\aa} tillf{\"a}llet i akt att erinra oss om att {\"a}ven om vi
h{\"a}r f{\"o}r enkelhets skull diskuterat Lorentzkraften s{\aa} som den
skulle agerat p{\aa} en fysisk laddning $q$ i r{\"o}relse, s{\aa} {\"a}r
resultatet i form av Faradays lag en {\it relation mellan f{\"a}lt}, specifikt
visande att i n{\"a}rvaro av tidsberoende magnetiska f{\"a}lt s{\aa} {\"a}r
rotationen f{\"o}r det elektriska f{\"a}ltet inte l{\"a}ngre noll.
Detta st{\aa}r i stark kontrast till det statiska fallet vilket vi analyserade
i F{\"o}rel{\"a}sning~2, d{\"a}r vi konstaterade att
$\nabla\times{\bf E}={\bf 0}$ f{\"o}r statiska f{\"a}lt.
...
$$
  {\cal E}=-{{d}\over{dt}}\iint_{S}{\bf B}({\bf x},t)\cdot d{\bf S}
    =-\iint_{S}{{d{\bf B}({\bf x},t)}\over{dt}}\cdot d{\bf S}
$$
Som exempel p{\aa} applikationer av Faradays induktionslag f{\"o}r
station{\"a}ra slingor kan n{\"a}mnas statorn, som {\"a}r den station{\"a}ra,
icke r{\"o}rliga komponenten i en generator, som typiskt inneh{\aa}ller spolar
av koppartr{\aa}d (lindningar) som omvandlar det varierande magnetf{\"a}ltet
fr{\aa}n magneter p{\aa} en rotor till elektrisk sp{\"a}nning via den
inducerade elektromotoriska ``kraften''.
Ett annat exempel {\"a}r pickupen p{\aa} en elgitarr, d{\"a}r magneter omgivna
av en spole via den vibrerande metalliska str{\"a}ngen f{\aa}ngar upp ett
varierande magnetiskt f{\"a}lt, och p{\aa} liknande s{\"a}tt skapar en signal
i form av en sp{\"a}nning.

\section{Spolar och utv{\"a}xling p{\aa} det magnetiska fl{\"o}det}
F{\"o}r en spole med $N$ varv, som vart och ett kan anses som identiska i
deras t{\"a}ckning av det magnetiska f{\"a}ltet och d{\"a}rmed vart och ett
...
$$
  {\cal E}
    ...
    =\underline{\underline{
        \iint_{S}\nabla\times{\bf E}({\bf r},t)\,d{\bf S}
     }}
    =-{{d\Phi_{\rm M}({\bf x},t)}\over{dt}}
    =\underline{\underline{
        -\iint_S{{d{\bf B}({\bf x},t)}\over{dt}}\,d{\bf S}
     }}.
$$
...
$$
  \nabla\times{\bf E}({\bf r},t)=-{{d{\bf B}({\bf x},t)}\over{dt}},
$$
...
$$
  ...
  =-\iint_S{{d{\bf B}({\bf x},t)}\over{dt}}\,d{\bf S}
  =\underline{\underline{
     -{{d}\over{dt}}\iint_S{\bf B}({\bf x},t)\,d{\bf S}
   }},
$$
...
tidsvarierande magnetiskt f{\"a}lt och kan generera str{\"o}m genom en annan
slinga, s{\"a}g $\Gamma'$.
...
$$
  \eqalign{
    \Phi_{\rm M}&=\iint_{S}{\bf B}({\bf x},t)\,d{\bf S}
...
$$
  \eqalign{
    \Phi_{\rm M}&=\iint_{S}{\bf B}({\bf x},t)\,d{\bf S}
        \qquad\hbox{(Genom sekund{\"a}rloopen $\Gamma$)}\cr
      &=\big\{\hbox{ Vektorpotential ${\bf B}=\nabla\times{\bf A}$ }\big\}\cr
      &=\iint_{S}\nabla\times{\bf A}({\bf x},t)\,d{\bf S}\cr

...
\centerline{Fredrik Jonsson, Uppsala Universitet, 26 november 2025}
\vskip24pt
...
\plan{Maxwells ekvationer och den elektromagnetiska v{\aa}gekvationen
  ...
  approximationer:
    ...
    (ii)  $\rho={\bf 0}$ (inga fria laddningar),
  ...
  f{\"o}r v{\aa}gekvationen och visar p{\aa} hur denna i en dimension har
...
% $f(\xi)=f(z-ct)$ samt en annan funktion, s{\"a}g, $g(\eta)=g(z+ct)$
% (b{\aa}da med sina respektive amplituder, som givetvis {\"a}ven kan vara
% noll). Sammantaget med superpositionsprincipen f{\"o}r linj{\"a}ra
% (ordin{\"a}ra s{\aa} v{\"a}l som partiella) differentialekvationer ger
% d{\aa} att
%
$$
...
\item{$\bullet$}{Fyra allm{\"a}nna f{\"o}renklingar,
  ...
  \litem[2.]{$\rho={\bf 0}$ (inga fria laddningar)}

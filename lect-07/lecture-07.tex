...
Amp\`eres modell av magnetiska dipoler som sm{\aa} str{\"o}mslingor har en
intressant och generellt giltig tolkning i ett makroskopiskt perspektiv.
Notera att str{\"o}mmen som i modellen ses generera ett magnetiskt dipolmoment
{\"a}r {\it bunden}, det vill s{\"a}ga att laddningarna inte {\"a}r fria att
r{\"o}ra sig i mediet, bara i ``sm{\aa}'' cirklar runt den punkt d{\"a}r vi
betraktar dipolmomentet. Dessa str{\"o}mmar kan vi p{\aa} ytan av ett
magnetiserat objekt beskriva som bundna {\it ytstr{\"o}mmar}, betecknade
$K_{\rm b}$ (enhet ${\rm A}/{\rm m}$), samt i volymen av objektet som bundna
{\it volymstr{\"o}mmar}, betecknade $J_{\rm b}$ (enhet ${\rm A}/{\rm m}^2$).
\epsfig{figs/magcurrent.1}\noindent
Yttryckt i de bundna yt- och volymstr{\"o}mmarna $K_{\rm b}$ och $J_{\rm b}$ kan
magnetiseringen lokalt p{\aa} och i mediet uttryckas
som\numberedfootnote{Griffiths Ekv.~(6.13), sid.~275.}
$$
  {\bf J}_{\rm b}=\nabla\times{\bf M}
                 \qquad(\hbox{volymstr{\"o}m},\ {\rm C}/{\rm m}^2),\qquad\qquad
  {\bf K}_{\rm b}={\bf M}\times{\bf e}_n
                 \qquad(\hbox{ytstr{\"o}m},\ {\rm C}/{\rm m}).
$$

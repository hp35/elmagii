...
\def\lecture #1 {\hsize=150mm\hoffset=4.6mm\vsize=230mm\voffset=7mm
  ...
  \vskip-42pt\hfill\vbox{
    ...
    \centerline{\twelvesc F{\"o}rel{\"a}sning #1}
  \vskip 24pt\noindent}
...
\centerline{Fredrik Jonsson, Uppsala Universitet, 19 november 2025}
\vskip24pt
...
\plan{I denna f{\"o}rel{\"a}sning analyserar vi vad som h{\"a}nder d{\aa}
  ...
  permanentmagneter. Krafter och moment p{\aa} magnetiska dipoler extraheras
  fr{\aa}n upplagrade energier f{\"o}r dipoler i elektriska eller magnetiska
  f{\"a}lt, och vi introducerar magnetisering som en ``magnetisk
  polarisationsdensitete'', i analogi med den elektriska motsvarigheten.
...
Amp\`eres modell av magnetiska dipoler som sm{\aa} str{\"o}mslingor har en intressant och generellt giltig tolkning i ett makroskopiskt perspektiv. Notera att str{\"o}mmen som i modellen ses generera ett magnetiskt dipolmoment {\"a}r {\it bunden}, det vill s{\"a}ga att laddningarna inte {\"a}r fria att r{\"o}ra sig i mediet, bara i ``sm{\aa}'' cirklar runt den punkt d{\"a}r vi betraktar dipolmomentet. Dessa str{\"o}mmar kan vi p{\aa} ytan av ett magnetiserat objekt beskriva som bundna {\it ytstr{\"o}mmar}, betecknade $K_{\rm b}$ (enhet ${\rm A}/{\rm m}$), samt i volymen av objektet som bundna {\it volymstr{\"o}mmar}, betecknade $J_{\rm b}$ (enhet ${\rm A}/{\rm m}^2$).
\epsfig{figs/magcurrent.1}\noindent
Yttryckt i de bundna yt- och volymstr{\"o}mmarna $K_{\rm b}$ och $J_{\rm b}$ kan magnetiseringen lokalt p{\aa} och i mediet uttryckas som\numberedfootnote{Griffiths Ekv.~(6.13), sid.~275.}
$$
  {\bf J}_{\rm b}=\nabla\times{\bf M}\qquad(\hbox{volymstr{\"o}m},\ {\rm C}/{\rm m}^2),\qquad\qquad
  {\bf K}_{\rm b}={\bf M}\times{\bf e}_n\qquad(\hbox{ytstr{\"o}m},\ {\rm C}/{\rm m}).
$$
d{\"a}r ${\bf e}_n$ {\"a}r normalvektorn ut fr{\aa}n den slutna ytan hos det magnetiserade objektet.
\vfill\eject
...
vi ser sm{\aa} volumselement $dV$ som en ensemble av k{\"a}llpunkter, var och
en uppb{\"a}rande en rumsberoende magnetisering (``magnetisk
polarisationsdensitet'') ${\bf M}({\bf x}')$.
\epsfig{figs/vectpot.1}\noindent
...
Vi kan h{\"a}r till{\"a}mpa partiell integration\numberedfootnote{Av n{\aa}gon
  ...
  insidan av p{\"a}rmen som en {\it Product Rule}.}
...
$d{\bf A}'={\bf e}_n\,dA'$. Summa summarum kan allts{\aa} vektorpotentialen
skrivas i termer av ekvivalenta volyms- och ytstr{\"o}mmar som
$$
  {\bf A}({\bf x}) = {{\mu_0}\over{4\pi}}\iiint_V
    {{{\bf J}_{\rm b}({\bf x}')}\over{|{\bf x}-{\bf x}'|}}\,dV'
  +{{\mu_0}\over{4\pi}}\oiint_V
    {{{\bf K}_{\rm b}({\bf x}')}\over{|{\bf x}-{\bf x}'|}}\,dA'.
$$
...
\item{$\bullet$}{F{\"o}r en observat{\"o}r g{\aa}r ett {\it magnetiserat}
  ...
  hade uppburit l{\"a}mpligt konstruerade volyms- och en ytstr{\"o}mmar
  ${\bf J}_{\rm b}$ och ${\bf K}_{\rm b}$.}

...
$\nabla$ opererar p{\aa} {\it oprimmade} koordinater ${\bf x}$) ger oss att
$$
  \eqalign{
  \nabla\times{\bf B}({\bf x})
    &={{\mu_0}\over{4\pi}}\iiint_V\nabla\times
...
Notera att detta resultat g{\"a}ller {\it oberoende} av v{\"a}rdet p{\aa} radien
$R=|{\bf x}-{\bf x}'|>0$, som vi kan v{\"a}lja godtyckligt liten runt
k{\"a}llpunkten ${\bf x}'$.

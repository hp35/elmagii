...
f{\"o}rekomsten av\numberedfootnote{Termen ``permeabilitet'' myntades 1885
  av Oliver Heaviside.}
$$
  \mu_0=4\pi\times10^{-7}\ {\rm H}/{\rm m}\quad(\hbox{exakt per definition})
$$
f{\"o}r den {\it magnetiska permeabiliteten i vakuum}; detta {\"a}r f{\"o}rsta
g{\aa}ngen som $\mu_0$ dyker upp i denna kurs, p{\aa} exakt samma s{\"a}tt som
$\varepsilon_0$ d{\"o}k upp f{\"o}r f{\"o}rsta g{\aa}ngen i elektrostatiken i
och med att vi introducerades till Coulombs lag. I sj{\"a}lva verket kan vi
h{\"a}danefter generellt identifiera ``sl{\"a}kttr{\"a}det'' f{\"o}r v{\aa}ra
ekvationer som
\medskip
...
utifr{\aa}n den generella beskrivningen av det i termer av str{\"o}mt{\"a}theten
${\bf J}$, s{\aa} har vi att\numberedfootnote{Griffiths Ekv.~(5.50), sid.~232.}
$$
  \eqalign{
  \nabla\cdot{\bf B}({\bf x})
    &={{\mu_0}\over{4\pi}}\nabla\cdot\iiint_V
...
$\nabla\times(\nabla f)=0$ f{\"o}r godtycklig skal{\"a}r funktion $f$, s{\aa}
f{\"o}ljer det direkt att rotationen ovan {\"a}r identiskt noll, och
f{\"o}ljdaktligen ocks{\aa} att divergensen f{\"o}r magnetf{\"a}ltet {\"a}r
identiskt noll.
...
``magnetisk laddning''. V{\aa}r slutsats blir d{\"a}rmed:

...
\plan{Med en kort sammanfattning av historiken bakom uppt{\"a}ckandet av
  ...
  tidsderivatan av laddningst{\"a}theten. Biot--Savarts lag introduceras
...
i problemet rej{\"a}lt {\"o}verstiger storleken p{\aa} dom{\"a}nen som
analyseras.
...
$$
  ...
  \mu_0\underbrace{\iint_{S}{\bf J}\cdot d{\bf A}}_{\displaystyle =I_{\rm enc}},
$$

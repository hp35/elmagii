...
teorin inte g{\aa}r att applicera p{\aa} tidsberoende problem, bara under
f{\"o}ruts{\"a}ttningen att f{\"o}rloppen {\"a}r l{\aa}ngsamma nog att f{\"o}r
att den elektromagnetiska v{\aa}gl{\"a}ngden i problemet rej{\"a}lt
{\"o}verstiger storleken p{\aa} dom{\"a}nen som analyseras.
...
uppt{\"a}ckt att orienteringen hos en kompassn{\aa}l p{\aa}verkas av en
...
och magnetiska moment som kan ses som mikroskopiska slutna str{\"o}mslingor.
...
str{\"o}m i {\it str{\"o}mslingor}.
\quote{{\bf Definition} Vi definierar str{\"o}m som den laddning, vanligtvis
  elektroner, som transporteras genom en givet tv{\"a}rsnitt per tidsenhet.}
\noindent
...
anv{\"a}nda Gauss lag\numberedfootnote{Se exempelvis innerp{\"a}rmen p{\aa}
  Griffiths, {\it Divergence theorem}:
  $$
...
$$
Fl{\"o}det i den slutna ytintegralen definieras som fl{\"o}det {\it ut genom
ytan}, och vi kan som en liten {\it sanity check} konstatera att minustecknet
i h{\"o}gerledet d{\"a}rmed betyder att positiv laddning som fl{\"o}dar ut
genom ytan motsvaras av en motsvarande minskning av positiv laddning i volymen
$V$, helt enligt f{\"o}rv{\"a}ntan.
...
de franska fysikerna Jean-Baptiste Biot och F\'elix Savart (b{\aa}da i Paris)
samma {\aa}r upp f{\"o}rs{\"o}k med att fysikaliskt m{\"a}ta hur stort det
genererade magnetf{\"a}ltet var och vilka lagar som kunde t{\"a}nkas styra
det.\numberedfootnote{Herman Erlichson, {\it The experiments of Biot and
  Savart concerning the force exerted by a current on a magnetic needle},
  Am.~J.~Phys. {\bf 66} (1998).}
...
bidraget\numberedfootnote{Notera {\aa}terigen att vi h{\"a}r l{\"a}tt
  ...
  \numberedfootnote{Det finns ett par underh{\aa}llande
    ...
    relativitetsteorin applicerad på en reservoar av laddning.

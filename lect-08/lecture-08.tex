...
\sidx{Magnetiskt kvadrupolmoment}[Fr{\aa}n multipolutveckling av vektorpotential]
...
lag,\numberedfootnote{Se F{\"o}rel{\"a}sning~5 eller Griffiths Ekv.~(7.16),
  sid.~313.}
$$
  \underbrace{
...
$$
vilket direkt ger vid hand att magnetiska monopoler inte kan existera dynamiskt
heller. Argumentet ovan betyder ocks{\aa} att Gauss lag f{\"o}r den magnetiska
fl{\"o}dest{\"a}theten {\"a}r identisk i magnetostatiska s{\aa}v{\"a}l som i
elektrodynamiska situationer.
\vfill\eject

...
{\it magnetiska monopoler inte existerar i magneto-statiska problem}.\numberedfootnote{Vi kan rekapitulera att vi inom magnetostatiken fann $\nabla\cdot{\bf B}=0$ som en direkt f{\"o}ljd av formen p{\aa} Biot--Savarts lag f{\"o}r en generell str{\"o}mt{\"a}thet, samt fr{\aa}n identiteten
$$

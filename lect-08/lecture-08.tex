%
% File: teaching/elmag/lect-08/lecture-08.tex [plain TeX code]
% Last change: November 28, 2024
%
% Lecture No 8 in the course ``Elektromagnetism II, 1TE626 (2023)'',
% held November 28, 2024, at Uppsala University, Sweden.
%
...
%\def\section#1{\bigskip\noindent{\bf#1}\par\medskip\goodbreak\noindent}
%\def\ffig#1{\smallskip\centerline{\epsfbox{#1}}}
\lecture{8}
...
$$
\smallskip
\centerline{\epsfbox{figs/eldipole.1}}
\medskip
\noindent
...
\bigskip
\centerline{\epsfbox{figs/quadrupole.1}}
\medskip
\noindent
\bigskip
\centerline{\epsfbox{figs/octopole.1}}
\medskip
\noindent
...
\smallskip
\centerline{\epsfbox{figs/linelquadpole.1}}
\vfill\eject
\noindent
...
\bigskip
\centerline{\epsfbox{figs/chargedist.1}}
\medskip
\noindent

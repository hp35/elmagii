...
\item{$\bullet$}{Formalism f{\"o}r att projicera ut olika bidrag (``moment'')
   till elektromagnetiska f{\"a}lt.\sidx{Elektrisk f{\"a}ltstyrka ${\bf E}$}}
\item{$\bullet$}{Ofta f{\"o}rekommande f{\"o}r karakterisering av antenner.
                 \sidx{Antenner}}
\item{$\bullet$}{\sidx{Molekyler} som interagerar med elekromagnetiska f{\"a}lt
...
\sidx{Multipolutveckling}[F{\"o}r generell laddningsf{\"o}rdelning]

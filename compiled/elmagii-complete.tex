...
elektromagnetiska processer i tre olika regimer:
\medskip
...
F{\"o}r elektromagnetiska v{\aa}gor i vacuum {\"a}r sambandet mellan
v{\aa}gl{\"a}ngd och frekvens\numberedfootnote{Vi kommer i kursen att
  ...
  vacuum generellt skalar med elektrisk permittivitet och magnetisk
...
$$
  c_0=299\,792\,458\ {\rm m}/{\rm s}\approx 3\times 10^8\ {\rm m}/{\rm s}
$$
{\"a}r ljushastigheten i vacuum.
Detta samband {\"a}r avg{\"o}rande f{\"o}r att avg{\"o}ra vilken approximation
som kan anv{\"a}ndas.

{\it Elektrostatik} behandlar elektriska f{\"a}lt som {\"a}r {\it statiska}
och d{\"a}rmed {\it inte varierar med tiden}. Samtliga elektriska laddningar
betraktas som helt stillast{\aa}ende och inga elektromagnetiska v{\aa}gor
genereras {\"o}verhuvudtaget.
...
Formellt kan man uttrycka det villkoret f{\"o}r elektrostatisk regim som
$$
  L \ll \lambda.
$$
...
Om exempelvis en sp{\"a}nning varierar med frekvensen $50\ {\rm Hz}$, som i ett
vanligt kraftn{\"a}t, s{\aa} blir den elektromagnetiska v{\aa}gl{\"a}ngden som
skapas i systemet
$$
  \lambda = {{3 \times 10^8\ {\rm m}/{\rm s}}\over{50\ {\rm Hz}}}
    \approx 6\,000\ {\rm km},
$$
...
{\it Elektro-kvasistatik} {\"a}r n{\"a}sta niv{\aa}, d{\"a}r de elektriska
f{\"a}lten i systemet f{\"o}rvisso varierar i tiden, men fortfarande s{\aa}
l{\aa}ngsamt att v{\aa}gutbredning och str{\aa}lning kan f{\"o}rsummas inom
...
Villkoret f{\"o}r en elektro-kvasistatisk regim {\"a}r allts{\aa} fortfarande
``ungef{\"a}r'' att
$$
  L \ll \lambda,
$$
...
En viktig tumregel inom elektronik {\"a}r att kretsmodeller med diskreta
...
frekvensen\numberedfootnote{En bra tumregel att ha i bakhuvudet {\"a}r
  att en f{\"o}rflyttning med ljushastigheten $c_0$ under en nanosekund
  motsvarar cirka 30 centimeter, eller en fot -- ``ljusfoten''.}
...
{\it Elektrodynamik} {\"a}r den regim d{\"a}r systemets dimensioner $L$ blir
j{\"a}mf{\"o}rbara med den elektromagnetiska v{\aa}gl{\"a}ngden $\lambda$ i
problemet, och vi {\"o}verg{\aa}r d{\aa} fr{\aa}n den elektro-kvasistatiska
modellen till fullt utvecklad elektrodynamik.
...
hastighet d{\"a}r fortfarande ger obetydliga f{\"o}rdr{\"o}jningar inom systemet.
...
elektronik, medan elektro-kvasistatik anv{\"a}nds inom n{\"a}stan all l{\aa}g- och
medelfrekvent elektronik.

...
\def\copyrights{
  ...
  \line{Elektromagnetism II (1TE626) f{\"o}r Teknisk Fysik\hfil}
  ...
  \vfill
  \line{Copyright \copyright\ \the\year, Fredrik Jonsson under GNU
...
\preface{{\it First things first}\medskip\noindent
  ...
  xi, en {\it V{\"a}rldskarta {\"o}ver elektromagnetisk f{\"a}ltteori}
  ...
  bifogad p{\aa} sidorna xiii--xix, vilka kan vara l{\"a}mpliga att skriva ut
  och ha till hands i fysisk form under det att l{\"a}saren l{\"o}ser problem
  under lektioner eller p{\aa} egen kammare.

  \bigskip\noindent{\it Redan de gamla grekerna...}\medskip\noindent
  Det blir alltid intressantare med teori och filosofi n{\"a}r man har ett
  ansikte att knyta upp en ekvation eller relation p{\aa}, och d{\aa} allra
  helst g{\"a}rna en kort anekdot. P{\aa} sidorna xxi--xxviii har ett s{\aa}dant
  {\it Portr{\"a}ttgalleri inom klassisk elektromagnetism} sammanst{\"a}llts,
  med hopp om att ge liv i det stundvis torra och matematiskt intensiva
  {\"a}mne som elektromagnetisk f{\"a}ltteori utg{\"o}r.
...
\halign{#\hfil\ &#\hfil&\quad\hfil(#)\cr
  $dl$       & Skal{\"a}rt linjeelement l{\"a}ngs kurva
             & ${\rm m}$\cr
  $d{\bf l}$ & Riktat linjeelement $d{\bf l}={\bf e}_l dl$ l{\"a}ngs kurva
             & ${\rm m}$\cr
  $dS$       & Skal{\"a}rt ytelement
             & ${\rm m}^2$\cr
  $d{\bf S}$ & Riktat ytelement $d{\bf S}={\bf e}_n dS$ ut fr{\aa}n yta
             & ${\rm m}^2$\cr
...
$$
  \nabla{{1}\over{|{\bf x}-{\bf x}'|}}
    ...
    =-{{({\bf x}-{\bf x}')}\over{|{\bf x}-{\bf x}'|^3}}.
$$
\eqtitle{``Tricket II'' -- anv{\"a}nds f{\"o}r att visa att $\nabla\cdot{\bf B}=0$
\sidx{Tricket $\displaystyle\nabla{{1}\over{\char124}{\bf x}-{\bf x}'{\char124}}
...
\def\faraday{%
  \portrait{images/michael_faraday_scaled_bw.eps}%
    ...
    {1791--1867}%
    {\ifnum\lang=\swedish
      {Engelsk kemist och fysiker. ``The Rock Star'' inom elektrodynamik.
      Formulerade prin\-cip\-en f{\"o}r
      elektromagnetisk induktion, diamagnetism och elektrolys. I denna
      kurs anv{\"a}nder vi frek\-vent Faradays induktionslag
      $$
        \abovedisplayskip=3pt
        \belowdisplayskip=3pt
        {\cal E}= -{{d\Phi_{\rm M}}\over{dt}}
    ...
    \else
      {English chemist, physicist, and ``Rock Star'' in electrodynamics.
      Discovered the principles behind electromagnetic induction,
      diamagne\-tism, and electrolysis. In this course, we make frequent
      ...
      $$
        ...
        {\cal E}= -{{d\Phi_{\rm M}}\over{dt}}
          ...
          \nabla\times{\bf E}=-{{\partial{\bf B}}\over{\partial t}},
      $$
      derived from the Lorentz force, independently of
      Coulombs' or Biot--Savart's laws.}
    \fi}%
...
\def\tesla{%
  \portrait{images/nikola_tesla_scaled_bw.eps}%
    ...
    {\ifnum\lang=\swedish
      ...
      efter honom p{\aa} {\it Conf\'erence G\'en\'erale des Poids et Mesures}
      i Paris, Frankrike.}
    \else
      ...
      The unit tesla (T) of the magnetic field ${\bf B}$ was in 1960 named
      after him, at the {\it Conf\'erence G\'en\'erale des Poids et Mesures}
      in Paris, France.}
    \fi}%
...
\def\gpthomson{%
  \portrait{images/george_paget_thomson_scaled_bw.eps}%
    ...
    \fi}%
    \sidx{Thomson, George Paget (1892--1975)}
}
...
med ett namn eller ekvation. Detta portr{\"a}ttgalleri t{\"a}cker de prim{\"a}ra
uppt{\"a}ckarna inom elektrostatik, magnetostatik och elektrodynamik.
\else
Electromagnetism as a subject is packed with celebrities from classical physics,
and it is always nice to have a face associated with a name or equation. This
portrait gallery covers the primary discoverers in electrostatics,
...
\ifeof\imgtest
  % File does NOT exist
  \ifnum\lang=\swedish
    \centerline{{\epsfxsize=480pt
      \epsfbox{../gallery/timeline/timeline-swedish.eps}}}
  \else
    \centerline{{\epsfxsize=480pt
      \epsfbox{../gallery/timeline/timeline-english.eps}}}
  \fi
\else
  % File exists
  \closein\imgtest
  \ifnum\lang=\swedish
    \centerline{{\epsfxsize=480pt
      \epsfbox{timeline/timeline-swedish.eps}}}
  \else
    \centerline{{\epsfxsize=480pt
      \epsfbox{timeline/timeline-english.eps}}}
  \fi
\fi
\vfill\eject
...
\section{\red{Begreppen elektrostatik, elektro-kvasistatik och elektrodynamik}}
Inom elektromagnetism {\"a}r kan vi i huvudsak dela upp elektriska och
{\red{elektromagnetiska processer i tre olika regimer}}:
\medskip
\item{1.}{elektrostatik,}
\item{2.}{elektro-kvasistatik, samt}
\item{3.}{elektrodynamik.}
\medskip
\noindent
Dessa omr{\aa}den beskriver i grunden samma fysik, men {\"a}r giltiga under
{\it olika antaganden om hur snabbt systemen varierar i tiden och hur stora
de geometriska dimensionerna {\"a}r i f{\"o}rh{\aa}llande till den
elektromagnetiska v{\aa}gl{\"a}ngden}.
En central storhet blir d{\"a}rf{\"o}r relationen mellan systemets
karakteristiska storlek (s{\"a}g, $L$), den elektromagnetiska
v{\aa}gl{\"a}ngden ($\lambda$) och ljushastigheten ($c_0$ i vakuum).
\sidx{Elektromagnetisk v{\aa}gl{\"a}ngd}

F{\"o}r elektromagnetiska v{\aa}gor i vakuum {\"a}r {\red{sambandet mellan
v{\aa}gl{\"a}ngd och frekvens}}\numberedfootnote{Vi kommer i kursen att
  h{\"a}rleda fram hur ljushastigheten $c_0$ i ett medium som inte {\"a}r
  vakuum generellt skalar med elektrisk permittivitet och magnetisk
  permeabilitet; mer om detta och konceptet {\it brytningsindex} senare.}
$$
  \red{\lambda = {{c_0}/{f}}}
$$
d{\"a}r $f$ {\"a}r frekvensen f{\"o}r den process vi betraktar, samt d{\"a}r
$$
  \red{c_0=299\,792\,458\ {\rm m}/{\rm s}\approx 3\times 10^8\ {\rm m}/{\rm s}}
$$
{\"a}r ljushastigheten \sidx{Ljushastighet} i vakuum.
Detta samband {\"a}r avg{\"o}rande f{\"o}r att avg{\"o}ra vilken approximation
som kan anv{\"a}ndas.

{\it{\red{Elektrostatik}}} behandlar elektriska f{\"a}lt som {\"a}r
{\it statiska} och d{\"a}rmed {\it inte varierar med tiden}.
Samtliga elektriska laddningar betraktas som helt stillast{\aa}ende och inga
elektromagnetiska v{\aa}gor genereras {\"o}verhuvudtaget.
Matematiskt inneb{\"a}r detta att alla tidsderivator av de elektriska
f{\"a}lten {\"a}r identiskt noll. Det elektriska f{\"a}ltet best{\"a}ms d{\aa}
direkt av laddningsf{\"o}rdelningen genom Coulombs lag och Poissons ekvation,
vilka vi kommer att studera grundligt i F{\"o}rel{\"a}sning~2 och~3.
\sidx{Elektrostatik}

Inom elektrostatik antas f{\"o}r{\"a}ndringar ske s{\aa} l{\aa}ngsamt att
information i praktiken hinner spridas momentant genom systemet vi studerar.
Detta inneb{\"a}r {\it inte} att ljushastigheten i sig {\"a}r o{\"a}ndlig, utan
bara att f{\"o}rdr{\"o}jningen genom systemet {\"a}r f{\"o}rsumbar
j{\"a}mf{\"o}rt med de tidsvariationer som annars f{\"o}rekommer.
Formellt kan man uttrycka det villkoret f{\"o}r {\red{elektrostatisk regim}} som
$$
  \red{L \ll \lambda}.
$$
I elektrostatisk regim {\"a}r allts{\aa} systemets dimensioner v{\"a}esentligt
mycket mindre {\"a}n den elektromagnetiska v{\aa}gl{\"a}ngden, som om
frekvensen $f\approx0$ sj{\"a}lvfallet blir o{\"a}ndlig.
Om exempelvis en sp{\"a}nning varierar med {\red{frekvensen $50\ {\rm Hz}$,
som i v{\aa}rt vanliga eln{\"a}t}}, s{\aa} blir den elektromagnetiska
v{\aa}gl{\"a}ngden som skapas i systemet
$$
  \red{\lambda = {{3 \times 10^8\ {\rm m}/{\rm s}}\over{50\ {\rm Hz}}}
    \approx 6\,000\ {\rm km}},
$$
eller lite knappt avst{\aa}ndet mellan Uppsala och New York!
En elektrisk apparat som endast {\"a}r n{\aa}gra centimeter eller f{\"o}r den
delen ett par meter stor {\"a}r d{\aa} extremt liten j{\"a}mf{\"o}rt med
v{\aa}gl{\"a}ngden, vilket inneb{\"a}r att elektrostatisk eller kvasistatisk
approximation ofta fungerar mycket v{\"a}l.
Typiska exempel p{\aa} elektrostatiska problem {\"a}r laddade kondensatorer,
elektriska f{\"a}lt kring isolatorer samt ber{\"a}kningar av kapacitans.
{\"A}ven m{\aa}nga h{\"o}gsp{\"a}nningsproblem behandlas elektrostatisk s{\aa}
l{\"a}nge variationerna {\"a}r l{\aa}ngsamma.

{\it{\red{Elektro-kvasistatik}}} {\"a}r n{\"a}sta niv{\aa}, d{\"a}r de
elektriska f{\"a}lten i systemet f{\"o}rvisso varierar i tiden, men fortfarande
s{\aa} pass l{\aa}ngsamt att v{\aa}gutbredning och str{\aa}lning helt kan
f{\"o}rsummas inom systemets dimensioner.
Det finns d{\aa} tidsberoende str{\"o}mmar och sp{\"a}nningar, men de
elektromagnetiska f{\"a}lten hinner fortfarande ``anpassa sig'' n{\"a}stan
omedelbart {\"o}ver hela systemet, och vi kan fortfarande med god approximation
f{\"o}rsumma eventuella tidsf{\"o}rdr{\"o}jningar.
\sidx{Elektro-kvasistatik}

Villkoret f{\"o}r en {\red{elektro-kvasistatisk regim}} {\"a}r allts{\aa}
fortfarande ``ungef{\"a}r'' att
$$
  \red{L \ll \lambda},
$$
men nu till{\aa}ts allts{\aa} tidsvariationer. Skillnaden mot ren elektrostatik
{\"a}r att f{\"o}rskjutningsstr{\"o}mmar och tidsberoende
laddningsf{\"o}rdelningar kan f{\"o}rekomma.
D{\"a}remot {\"a}r fasf{\"o}rskjutningar {\"o}ver systemets dimensioner sm{\aa}
och man beh{\"o}ver normalt inte beskriva fenomenet som en utbredd v{\aa}g.

Elektro-kvasistatik anv{\"a}nds exempelvis i vanlig kretsanalys, samt {\"a}ven
analys av klassiska generatorer, elmotorer med mera.
N{\"a}r man exempelvis analyserar klassiska kretsar med resistorer,
kondensatorer och induktanser med Kirchhoffs lagar, s{\aa} antar man implicit
och i praktiken att signalerna sprids momentant genom kretsen, vilket {\"a}r
en mycket god approximation s{\aa} l{\"a}nge kretsens dimensioner {\"a}r
sm{\aa} j{\"a}mf{\"o}rt med v{\aa}gl{\"a}ngden.

En viktig {\red{tumregel inom elektronik}} {\"a}r att kretsmodeller med diskreta
``portade'' komponenter\numberedfootnote{Engelska: {\it Lumped circuits}
  eller {\it lumped-element model}, fr{\aa}n ``lumped'' som ungef{\"a}r
  betyder ``klumpa ihop'' p{\aa} svenska.}
fungerar bra om ledningsl{\"a}ngderna {\"a}r mindre {\"a}n ungef{\"a}r en
tiondel av v{\aa}gl{\"a}ngden, det vill s{\"a}ga att
$$
  \red{L \lesssim {{\lambda}/{10}}}.
$$
Om denna regel inte l{\"a}ngre uppfylls b{\"o}rjar effekter fr{\aa}n
transmissionsledningar bli viktiga. Exempelvis har en signal med
frekvensen\numberedfootnote{En anv{\"a}ndbar tumregel att ha i bakhuvudet
  {\"a}r att {\it en f{\"o}rflyttning med ljushastigheten $c_0$ under en
  nanosekund, eller periodtiden f{\"o}r en v{\aa}g med frekvensen 1~GHz,
  motsvarar ungef{\"a}r en fot -- ``ljusfoten'' -- eller cirka 30 centimeter}.}
en ljushastighet $1\ {\rm GHz}$ v{\aa}gl{\"a}ngden ungef{\"a}r $30\ {\rm cm}$.
Redan n{\aa}gra centimeters ledningsl{\"a}ngd kan d{\aa} ge m{\"a}rkbara
fasf{\"o}rskjutningar och reflektioner.

{\it{\red{Elektrodynamik}}} {\"a}r den regim d{\"a}r systemets dimensioner $L$
blir j{\"a}mf{\"o}rbara med den elektromagnetiska v{\aa}gl{\"a}ngden $\lambda$
i problemet, frt vill s{\"a}ga att vi inom {\red{elektrodynamisk regim}} har att
$$
  \red{L\approx\lambda},
$$
och vi {\"o}verg{\aa}r d{\aa} fr{\aa}n den elektro-kvasistatiska modellen till
fullt utvecklad elektrodynamik.
H{\"a}r m{\aa}ste f{\"a}lten ber{\"a}knas utifr{\aa}n Maxwells ekvationer och
behandlas utan kvasistatiska approximationer, och f{\"a}lten upptr{\"a}der som
utbredda elektromagnetiska v{\aa}gor som propagerar med {\"a}ndlig hastighet,
reflekteras, interfererar och str{\aa}lar energi.
\sidx{Elektrodynamik}

I elektrodynamiken {\"a}r sambandet mellan elektriska och magnetiska f{\"a}lt
helt centralt, och det {\"a}r d{\"a}rf{\"o}r som vi ibland s{\"a}tter ett
likhetstecken mellan ``elektrodynamik'' och ``elektromagnetism'', helt enkelt
d{\"a}rf{\"o}r att de elektriska och magnetiska f{\"a}lten kopplar direkt till
varandra genom Faradays och Amp\`eres lagar.
\sidx{Elektrodynamik}[och elektromagnetism]
Ett tidsvarierande elektriskt f{\"a}lt genererar ett magnetiskt f{\"a}lt och
vice versa, vilket leder till sj{\"a}lvuppr{\"a}tth{\aa}llande elektromagnetiska
v{\aa}gor.\numberedfootnote{Detta {\"a}r s{\aa} centralt att den f{\"o}rsta
  fr{\aa}gan p{\aa} tentamen kommer att vara h{\"a}rledningen av den
  elektromagnetiska v{\aa}gekvationen f{\"o}r det elektriska och magnetiska
  f{\"a}ltet fr{\aa}n Maxwells ekvationer; denna tentamensfr{\aa}ga med
  tillh{\"o}rande l{\"o}sningsf{\"o}rslag delas ut under f{\"o}rsta
  f{\"o}rel{\"a}sningen, med hopp om att {\"a}ven en mekanisk inl{\"a}rning
  av denna h{\"a}rledning kommer att assistera teknologen till att n{\aa}
  en djupare f{\"o}rst{\aa}else.}
Radiov{\aa}gor, mikrov{\aa}gor, ljus och r{\"o}ntgenstr{\aa}lning {\"a}r alla
exempel p{\aa} s{\aa}dana l{\"o}sningar till Maxwells ekvationer.
\sidx{Radiov{\aa}gor}
\sidx{Mikrov{\aa}gor}
\sidx{Ljus}
\sidx{R{\"o}ntgenstr{\aa}lning}
\sidx{Maxwells ekvationer}

Ett klassiskt exempel {\"a}r en antenn. Om antennens storlek {\"a}r av samma
storleksordning som v{\aa}gl{\"a}ngden kan den effektivt str{\aa}la
elektromagnetisk energi.
En halvv{\aa}gsdipol f{\"o}r frekvensen $100\ {\rm MHz}$ f{\aa}r exempelvis
den fysiska l{\"a}ngden
$$
  L \approx {{\lambda}\over{2}} = {{c_0}\over{2f}}\approx 1.5\ {\rm m}.
$$
H{\"a}r bildar v{\aa}gutbredningseffekterna och den elektromagnetiska
v{\aa}gl{\"a}ngden sj{\"a}lva grunden f{\"o}r funktionen hos systemet, som i
och med detta f{\aa}r en fysisk dimension $L\approx\lambda$ som {\"a}r i samma
storleksordning som v{\aa}gl{\"a}ngden i sig, och n{\aa}gon elektrostatisk
approximation {\"a}r om{\"o}jlig.

Skillnaden mellan de tre regimerna elektrostatik, elektro-kvasistatik, samt
elektrodynamik kan d{\"a}rf{\"o}r sammanfattas genom relationen mellan
tidsvariation (frekvens $f$), systemstorlek (karakteristisk l{\"a}ngd $L$) och
ljushastighet ($c_0$).
I {\it elektrostatiken} {\"a}r tidsvariationerna f{\"o}rsumbara, medan vi i
{\it elektro-kvasistatiken} har tidsvariationer, men att ljusets {\"a}ndliga
hastighet d{\"a}r fortfarande ger obetydliga f{\"o}rdr{\"o}jningar inom
systemet.
I {\it elektrodynamiken} blir d{\"a}remot den {\"a}ndliga propagations-%
hastigheten avg{\"o}rande och elektromagnetiska v{\aa}gor m{\aa}ste beskrivas
explicit.

Man kan ocks{\aa} formulera detta med hj{\"a}lp av den karakteristiska
propagations­tiden
$$
  \tau = {{L}/{c_0}},
$$
som anger hur l{\aa}ng tid det tar f{\"o}r elektromagnetisk information att
f{\"a}rdas genom systemet. Om denna tid {\"a}r mycket mindre {\"a}n tidsskalan
$1/f$ f{\"o}r variationen hos f{\"a}lten, s{\aa} kan kvasistatiska
approximationer anv{\"a}ndas. Om tiderna blir j{\"a}mf{\"o}rbara kr{\"a}vs
full v{\aa}gteori.
\sidx{Elektromagnetisk information}[utbredningshastighet]

Dessa approximationer {\"a}r mycket viktiga inom fysik och m{\"o}jligheten att
med en viss modell kunna ber{\"a}kna en effekt eller dimensionering.
Elektrostatik anv{\"a}nds exempelvis inom h{\"o}gsp{\"a}nning och statisk
elektronik, medan elektro-kvasistatik anv{\"a}nds inom n{\"a}stan all l{\aa}g-
och medelfrekvent elektronik.
Elektrodynamik som modell dominerar inom radar, mikrov{\aa}gsteknik, optik,
antennteori och modern telekommunikation, men {\"a}r on{\"o}digt komplicerad att
applicera som modell f{\"o}r statiska eller kvasistatiska problem.
Indelningen mellan omr{\aa}dena {\"a}r allts{\aa} inte absolut utan beror
p{\aa} skalor och approximationer. F{\"o}r att sammanfatta:
\quote{{\it Maxwells ekvationer {\"a}r modellen bakom all elektromagnetism,
  men beroende p{\aa} f{\"o}rh{\aa}llandet mellan den elektromagnetiska
  v{\aa}gl{\"a}ngd $\lambda$, systemets storlek $L$ och ljushastigheten
  $c_0$ kan fysiken beskrivas av mycket olika modeller.}}
\vfill\eject
...
\red{$$
  \hbox{Reciprocitet}\quad\Rightarrow\quad
  {\bf F}'={{q'q}\over{4\pi\varepsilon_0}}
     {{({\bf x}'-{\bf x})}\over{|{\bf x}'-{\bf x}|^3}}.
  \hphantom{\hbox{Reciprocitet}\quad\Rightarrow\quad}
$$}
\vfill\eject
...
\item{$\bullet$}{Virtuella fotoner existerar och kan p{\aa}visas inom ramverket
  ...
  partiklar, och de kan (i likhet med vanliga fotoner) ``l{\aa}na'' energi och
...
\item{$\bullet$}{F{\"a}ltmodellen till{\aa}ter oss att l{\aa}ta en laddnings
  ...
  motsvarande brytningsindex \sidx{Brytningsindex $n$} f{\"o}r mediet i rummet.}
...
riktningarna runt den punkt d{\"a}r vi befinner oss.\numberedfootnote{Om vi
  t{\"a}nker oss en analogi med rummet som en tv{\aa}dimensionell
  terr{\"a}ngkarta d{\"a}r v{\"a}rdet p{\aa} den skal{\"a}ra potentialen
  $\phi({\bf x})$ representerar h{\"o}jden {\"o}ver havet, eller om vi
  s{\aa} vill den {\it potentiella energin} som funktion av h{\"o}jden,
  s{\aa} g{\"a}ller f{\"o}ljande:\par
    {\it Riktning}: Gradienten $\nabla\phi({\bf x})$ pekar i den riktning
      d{\"a}r marken lutar som brantast upp{\aa}t. Om du st{\aa}r i en
      sluttning och vill g{\aa} den kortaste, brantaste v{\"a}gen mot toppen,
      ska du g{\aa} i gradientens riktning.\par
    {\it Magnitud}: Beloppet $|\nabla\phi({\bf x})|$ av gradienten anger
      hur brant lutningen {\"a}r. Ett stort belopp p{\aa} gradienten betyder
      en brant backe; en gradient p{\aa} noll betyder att man st{\aa}r p{\aa}
      en plan yta, som till exempel p{\aa} en topp, i en dal eller en p{\aa}
      plat{\aa}.}
\vfill\eject
...
\section{De elektriska f{\"a}ltlinjerna {\"a}r alltid ortogonala mot en
  ekvipotentialyta}
\sidx{Ekvipotentialyta}[Ortogonalitet mot elektriska f{\"a}ltlinjer]
\sidx{Elektrisk f{\"a}ltlinje}[Ortogonalitet mot Ekvipotentialyta]
Utifr{\aa}n slutsatsen att det enda netto-arbete som kan utf{\"o}ras vid
f{\"o}rflyttning av en laddning $q$ sker n{\"a}r den f{\"o}rflyttas l{\"a}ngs
med f{\"a}ltlinjer hos det elektriska f{\"a}ltet, s{\aa} f{\"o}ljer det att
{\it en f{\"o}rflyttning av laddning i en riktning ortogonalt mot
f{\"a}ltlinjerna aldrig kan resultera i n{\aa}got utf{\"o}rt arbete}.
\epsfig{../lect-02/figs/equipot.1}\noindent
Eftersom vi just har konstaterat att arbete dessutom kan uttryckas som en
f{\"o}r{\"a}ndring i potential $\phi$, och om vi r{\"o}r oss s{\aa} att inget
arbete utf{\"o}rs, s{\aa} blir slutsatsen f{\"o}ljande:
\quote{\red{\it Elektriska f{\"a}ltlinjer {\"a}r alltid ortogonala mot
  en ekvipotentialyta.}\numberedfootnote{En {\it ekvipotentialyta} {\"a}r
    kort och gott en yta i rummet d{\"a}r den skal{\"a}ra potentialen $\phi$
    {\"a}r konstant.}}
\noindent
Vi kan {\"a}ven betrakta detta mer matematiskt utifr{\aa}n formen p{\aa} det
elektriska f{\"a}ltet som ${\bf E}=-\nabla\phi$, d{\"a}r $-\nabla\phi$ {\"a}r
riktningen f{\"o}r snabbaste minskningen\numberedfootnote{``Steepest descent'';
  omv{\"a}nt s{\aa} {\"a}r $\nabla\phi$ med positivt tecken trivialt den
  snabbaste {\it {\"o}kningen} av den skal{\"a}ra potentialen.}
av den skal{\"a}ra potentialen, med denna riktning alltid varandes ortogonal
mot en ekvipotentialyta, eller konstant ``h{\"o}jdkurva'' om vi t{\"a}nker oss
analogin med en topografisk karta.
...
\item{$\bullet$}{Elektriska f{\"a}ltlinjer {\"a}r alltid ortogonala mot
  en ekvipotentialyta.}
...
$$
d{\"a}r $\Phi_{\rm M}$ {\"a}r det {\it magnetiska fl{\"o}det}, 
\sidx{Magnetiskt fl{\"o}de $\Phi_{\rm M}$} som vi strax kommer att definiera.
Vi brukar i vardagligt tal kalla
denna ekvation {\it Faradays induktionslag}\numberedfootnote{Denna beteckning
  ...
  $$
    \nabla\times{\bf E}=-{{\partial{\bf B}}\over{\partial t}}.
  $$
  Dock kommer vi inom kort att visa hur denna kan h{\"a}rledas ur just
...
\sidx{F{\"a}ltlinjer}[Magnetiska] som sk{\"a}r en yta per ytenhet.
...
p{\aa}.\numberedfootnote{Griffiths v{\"a}ljer tyv{\"a}rr att inte g{\aa}
  ...
  dessa l{\"o}sningar uppfyller v{\aa}gekvationen. Detta {\"a}r lite synd,
  eftersom man d{\"a}rmed missar en synnerligen illustrativ och nyttig koppling
  mellan flervariabelanalys och en grundl{\"a}ggande fysikalisk princip.
  Vi v{\"a}ljer d{\"a}rf{\"o}r att h{\"a}r passa p{\aa} att formellt g{\aa}
  igenom hur man kommer fram till formen
  $$
    E = f(z-ct) + g(z+ct)
  $$
  f{\"o}r endimensionell v{\aa}gutbredning i linj{\"a}ra media.
  Se Griffiths sid.~382--385.}

...
\def\tableofcontents{
  ...
  \message{Contents}
%  ~\vskip 5pc\goodbreak\noindent{\twelvecmbx Contents}\par
  ~\vskip 5pc\goodbreak\noindent{\twelvecmbx Inneh{\aa}ll}\par
%  \headline={\ifnum\abs\pageno>\abs\chapstartpage
%    \voffset=2\baselineskip\ifodd\pageno\rightheadline\else\leftheadline\fi
%    \else\voffset=0pt\hfill\fi}
%  \def\rightheadline{\hbox to 30pt{\hfil}
%    \hfil{\uppercase{\eightcmr Contents}}\hfil
%    \hbox to 30pt{\hfil\thepageno}}
%  \def\leftheadline{\hbox to 30pt{\thepageno\hfil}
%    \hfil{\uppercase{\eightcmr\bbooktitle}}\hfil
%    \hbox to 30pt{\hfil}}
%  \footline={\ifnum\pageno>\chapstartpage\hfil\else\hfil\thepageno\hfil\fi}
...
%  \secno=0
%  \footnotenumber=0
%  \writenumberedtocentry{chapter}{F{\"o}rel{\"a}sning #1}{\thechapno}
%  \message{==================== Lecture #1 ====================}
...
\def\initlecture#1#2#3#4#5#6#7#8#9{
  \advance\chapno by 1
  \secno=0
  \footnotenumber=0
  \def\coursename{#1}
  ...
  \def\courseyear{#3}
  \def\courserepo{#4}
  \edef\lecturenumber{#5}
  \edef\lecturetitle{#6}
  \edef\lecturetitlesub{#7}
  \edef\lectureauthor{#8}
  \edef\lectureplace{#9}
%  \def\lecturedate{#10}
...
%  \message{==================== Lecture \lecturenumber ====================}
  \message{writenumberedtocentry{chapter}{F{\"o}rel{\"a}sning #5}{#5}}
%  \writenumberedtocentry{chapter}{F{\"o}rel{\"a}sning #5}{#5}

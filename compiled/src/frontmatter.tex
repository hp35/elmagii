...
%
\ifx\zmanmacannounce\undefined \def\zmanmacannounce{\immediate\write16}\fi
 \zmanmacannounce{This is `complete.tex' v.0.1 <7 July 2025>}
...
%\def\preface[#1]#2\endpreface{%
%\leftskip=46pt\rightskip=46pt
%\noindent
%{\bf #1}
%\medskip\noindent
%#2%
...
\copyrights
\preface[F{\"o}rord]{
Detta är den kompletta serien av föreläsningar i kursen Elektromagnetism II (1TE626, 5hp), givna 2022--2025 för teknologer i Teknisk Fysik på Master-nivå.

...
$t$ & Tid & ${\rm s}$\cr
${\bf v}$ & Hastighet, $v=|{\bf v}|$ & ${\rm m}/{\rm s}$\cr
$V$ & Volym  & ${\rm m}^3$\cr
...
$$
\eqtitle{Lenz lag}
En inducerad str{\"o}m har en riktning som motverkar orsaken till att den uppkom.
Detta inneb{\"a}r att om magnetf{\"a}ltet genom en ledande slinga {\"o}kar,
s{\aa} kommer den i slingan inducerade str{\"o}mmen att ha en riktning som
skapar ett magnetf{\"a}lt som motverkar {\"o}kningen, och vice versa.
...
$$
  \eqalign{
    \int&x^n\,dx={{1}\over{(n+1)}}x^{n+1}\cr
...
\eqtitle{Kartesiska koordinater}
...
\eqtitle{Cylindriska koordinater}
\halign{#\hfil\quad & #\hfil\cr
  ...
  Linjeelement  & $d{\bf l}={\bf e}_rdr+{\bf e}_{\varphi}r\,d\varphi+{\bf e}_zdz$ \cr

...
Vi kan redan nu passa p{\aa} att sammanfatta begreppen elektrostatik och magnetostatik enligt f{\"o}ljande:
\medskip
...
Om vi ist{\"a}llet f{\"o}r en enskild punktladdning vid k{\"a}llpunkten betraktar ett {\it system} av $N$ ladd\-ningar $q'_k$ vid respektive positioner ${\bf x}'_k$ (med prim f{\"o}r konsekvent notation f{\"o}r k{\"a}llpunkter), {\"a}r den totala kraften som verkar p{\aa} laddningen $q$ vid observationspunkten uppenbarligen
$$
  \eqalign{
...
\section{Sammanfattning av F{\"o}rel{\"a}sning~1 -- Elektrostatik och superpositionsprincipen}
...
$$
  {\bf F}
    ={{q q'}\over{4\pi\varepsilon_0}}
      {{({\bf x}-{\bf x}')}\over{|{\bf x}-{\bf x}'|^3}}
    ={{q q'}\over{4\pi\varepsilon_0 r^2}}{\bf e}_r
$$
d{\"a}r
$$
  \varepsilon_0\approx8.854\times10^{12}\ {\rm F}/{\rm m}
...
{\"a}r konstanten f{\"o}r den {\it elektriska permittiviteten i vakuum}, eller
kort och gott {\it vakuumpermittiviteten}.}
\item{$\bullet$}{Det elektriska f{\"a}ltet fr{\aa}n ett system av punktladdningar $q'_k$ placerade i k{\"a}llpunkterna ${\bf x}'_k$ {\"a}r
$$

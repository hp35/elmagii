...
\plan{Med en kort sammanfattning av historiken bakom elektrostatik och
  ...
  f{\"o}ljs av en h{\"a}rledning av Coulomb-v{\"a}xelverkan f{\"o}r en
...
Gilberts {\it On Magnetism} (1600), d{\"a}r elektrisk attraktionskraft
separerades fr{\aa}n magnetism, samt Fran\c{c}ois de Cisternay du
...
Benjamin Franklin (1706--1790) utf{\"o}rde under {\aa}ren 1747--1749 experiment
...
Charles-Augustin de Coulomb (1736--1806) f{\"o}rtj{\"a}nar ett eget kapitel i
elektrostatikens historia, i och med publiceringen av hans {\it Second
M\'emoire sur l'\'Electricit\'e et le Magn\'etisme} [{\it Histoire de
...
med andra ord Coulombs lag s{\aa} som vi idag k{\"a}nner den, och som dessutom
...
{\aa}r innan den Brittiska fysikern Joseph John ``J.~J.'' Thomson (1856--1940,
Nobelpris i fysik 1906) visade p{\aa} existensen av elektroner 1897, genom
...
bestod av vad han fr{\aa}n b{\"o}rjan kallade ``korpuskler'' med negativ
...
atommodeller, som till exempel Ernest Rutherfords (1871--1937, Nobelpris i kemi
1908) uppt{\"a}ckt av atomk{\"a}rnan 1912, och Niels Bohrs (1885--1962,
...
punktladdningar $q$ och $q'$, r{\"a}knade med sina respektive tecken f{\"o}r
positiv eller negativ laddning och placerade i respektive
{\it observationspunkten} ${\bf x}$ och {\it k{\"a}llpunkten} ${\bf x}'$,
...
Sj{\"a}lvfallet agerar denna kraft reciprokt p{\aa} k{\"a}lladdningen $q'$, och
...
betraktar ett {\it system} av $N$ ladd\-ningar $q'_k$ vid respektive
...
\item{$\bullet$}{Formuleringen av uttrycket f{\"o}r det elektriska f{\"a}ltet
  {\"a}r {\it helt oberoende av testladdningen} $q$. Detta kan tyckas
...
\item{$\bullet$}{Denna m{\"o}jlighet att addera individuella del-l{\"o}sningar
  ...
  {\it superpositionsprincipen}, vilken {\"a}r generellt giltig enbart
...
Vi kan alla alltsedan sedan skoltiden i gymnasiet formen p{\aa} Coulombs lag,
...
\item{$\bullet$}{V{\"a}xelverkan mellan elementarpartiklar som b{\"a}r laddning
  sker via s{\aa} kallade {\it virtuella fotoner}, vilka skiljer sig fr{\aa}n
...
\item{$\bullet$}{Laddade partiklar som elektroner och protoner utbyter virtuella
  ...
  ut{\"o}va krafter p{\aa} varandra, s{\aa} som attraktion eller repulsion.}
...
betrakta Coulombs lag som en axiomatiskt given naturlag.
\vfill\eject
...
rummet}, f{\"o}rdelad enligt en laddningst{\"a}thet $\rho({\bf x})$ (${\rm C}
...
vi {\it Coulomb-integralen} f{\"o}r det elektriska f{\"a}ltet i en
observationspunkt ${\bf x}$ som\numberedfootnote{Notera att Griffiths
...
Coulombs lag? Denna ger ju direkt kraften, s{\aa} vad {\"a}r {\"o}verhuvud
...
\item{$\bullet$}{F{\"a}ltmodellen till{\aa}ter oss att l{\aa}ta en laddnings
  ...
  {\"a}r ljushastigheten eller denna nedskalad med motsvarande brytningsindex
...
\item{$\bullet$}{Detta g{\"o}r f{\"a}ltkonceptet kompatibelt med
  relativitetsteori och modern f{\"a}ltteori.}
...
\item{$\bullet$}{Detta visar p{\aa} att f{\"a}lt {\"a}r inte bara ett
  ...
  enbart varandes ett s{\"a}tt att dela upp Coulombs kraftlag i faktorer.}
\vfill\eject

\section{Gauss lag h{\"a}rledd i fyra steg}
Vi skulle h{\"a}r i princip bara kunna h{\"a}nvisa till den generella formen
av Gauss lag, men skulle d{\aa} riskera att missa n{\aa}gra intressanta
...
genom ytan'', r{\"a}knat med tecken utifr{\aa}n ytans normalvektor~${\bf n}$.
\vfill\eject

\subsection{Steg~1: Sf{\"a}risk symmetrisk omslutande yta och punktladdning}
Antag att vi har en punktladdning $q'$ placerad i position vid ortsvektorn

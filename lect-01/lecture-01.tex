...
respektive tecken f{\"o}r positiv eller negativ laddning och placerade i
respektive {\it observationspunkten}\idx{Observationspunkt} ${\bf x}$ och
{\it k{\"a}llpunkten}\idx{K{\"a}llpunkt} ${\bf x}'$,
...
\item{$\bullet$}{Denna m{\"o}jlighet att addera individuella del-l{\"o}sningar
  ...
  {\it superpositionsprincipen},\idx{Superpositionsprincipen} vilken {\"a}r
...
lag,\idx{Coulombs kraftlag} och till slut s{\"a}tter sig denna k{\"a}nsla
...
\item{$\bullet$}{V{\"a}xelverkan mellan elementarpartiklar som b{\"a}r laddning
  sker via s{\aa} kallade {\it virtuella fotoner}\idx{Virtuella fotoner}, vilka
...
f{\"o}rdelad enligt en laddningst{\"a}thet\idx{Elektrisk laddningst{\"a}thet}
...
av Gauss lag,\sidx{Gauss lag}[F{\"o}r elektrisk f{\"a}ltstyrka] men skulle
d{\aa} riskera att missa n{\aa}gra intressanta po{\"a}nger.
...
normalvektor\idx{Normalvektor}~${\bf n}$.
\vfill\eject

...
\def\red#1{\ifcolors{\color{red}#1}\else#1\fi}
%--------------------- END OF LOCAL MACROS ---------------------
...
Fays ``vitre{\"osa och resinu{\"o}sa'' (``vitreous and resinuous'')
...
beteckna som en ``virtuell sf{\"a}r'' \sidx{Virtuell sf{\"a}r} i detta
tankeexperiment, med radien $r$ centrerad runt denna punktladdning.
